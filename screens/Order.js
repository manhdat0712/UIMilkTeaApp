...
const Order = ({ navigation, route, appTheme }) => {
  ...
  const [selectedSideTab, setSelectedSideTab] = React.useState("Snack");
  ...
  React.useEffect(() => {
    let menuList = dummyData.menuList.filter(
      (menuItem) => menuItem.category === selectedSideTab
    );
    setMenu(menuList);
  }, [selectedSideTab]);
    ...
    return (
      <View>
        ...
        >
          <VerticalTextButton
            label="Snack"
            selected={selectedSideTab === "Snack"}
            onPress={() => setSelectedSideTab("Snack")}
          />

          <VerticalTextButton
            label="Coffee"
            containerStyle={{ marginTop: 30 }}
            selected={selectedSideTab === "Coffee"}
            onPress={() => setSelectedSideTab("Coffee")}
          />
          <VerticalTextButton
            label="Smoothie"
            containerStyle={{ marginTop: 50, width: 80 }}
            selected={selectedSideTab === "Smoothie"}
            onPress={() => setSelectedSideTab("Smoothie")}
          />

          <VerticalTextButton
            label="Specialtea"
            containerStyle={{ marginTop: 60, width: 85 }}
            selected={selectedSideTab === "Specialtea"}
            onPress={() => setSelectedSideTab("Specialtea")}
          />
          <VerticalTextButton
            label="Milk Tea"
            containerStyle={{ marginTop: 60, width: 80 }}
            selected={selectedSideTab === "Milk Tea"}
            onPress={() => setSelectedSideTab("Milk Tea")}
          />
        </View>
        <Svg height="65" width="65" viewBox="0 0 65 65">
